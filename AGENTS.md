...
- TypeScript 5.x, Node.js 24+ (ESM modules) + `@modelcontextprotocol/sdk` ^1.24.0, `zod` ^4.3.4, `puppeteer` ^23.11.1, `pdf-lib` ^1.17.1 (dev dep, will move to prod), `@mermaid-js/mermaid-cli` ^11.12.0 (009-pdf-deck-builder)
