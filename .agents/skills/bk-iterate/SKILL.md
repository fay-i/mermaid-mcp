---
name: bk-iterate
description: Address PR review feedback one comment at a time. Invoke per review round after pushing the branch and opening a PR. Requires gh CLI authenticated.
---
