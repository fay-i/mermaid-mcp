---
name: bk-session
description: Start a lightweight pairing session — branch + worktree, no spec/plan/behaviors workflow. Invoke for one-off fixes, refactors, QA passes, or interactive tweaks that don't warrant a full spec.
---
