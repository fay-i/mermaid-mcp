---
name: bk-specify
description: Generate a behavior-first spec with Given/When/Then acceptance criteria. Invoke when the user wants to start a new feature — they will provide a feature description as arguments.
---
...
> **Codex note:** invoke this skill as `/bk-specify` (Codex slash names can't contain dots).
