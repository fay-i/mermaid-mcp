---
name: bk-plan
description: Research existing codebase context for a feature spec. Invoke after /bk-specify, before /bk-behaviors. Read-only research pass — no architecture, no new code.
---
