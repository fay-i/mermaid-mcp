---
name: bk-implement
description: Implement behaviors one at a time using test-first development. Invoke after /bk-behaviors. Red → green → refactor, one commit per behavior.
---
...
> **Codex note:** invoke this skill as `/bk-implement` (Codex slash names can't contain dots).
