...
/**
 * MCP tool handler: mermaid_to_pdf with StorageBackend.
 * Converts Mermaid diagram source to PDF format, stores using StorageBackend,
 ...
 */
export async function mermaidToPdfWithStorage(
  input: MermaidToPdfInput,
